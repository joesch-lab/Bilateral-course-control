function [Data, Text_header, filename, samplingRate, minV, maxV]=openpr_flatten_translate(filename, plot_yn, meanwin)
...
%translate the data, so that the response is always positive
minD=min(Data(:,1));
Data(:,1)=Data(:,1)-minD;
