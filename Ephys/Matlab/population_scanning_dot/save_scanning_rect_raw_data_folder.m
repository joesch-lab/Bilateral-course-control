function save_scanning_rect_raw_data_folder(curfolder)
% curfolder='\\fs.ist.ac.at\dfsgroup\joeschgrp\Vika\EPhys\shakB_project\Repository\FlpND\VS\VS1_4\210128';
    ...
    for i=1:nfiles       
        ...
        rawdata_i=scanning_rect_one_recording(fulllog_file); 
    ...
    %save    
    if isempty(cellid)
        filename_i=['scaning_rect_',strain,'_',celltype,'_',datestr];        
    else
        filename_i=['scaning_rect_',strain,'_',celltype,'_',datestr,'_',cellid];        
    end    
